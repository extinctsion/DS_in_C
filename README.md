### *DS_in_C*
*In this repo you will find out the basic DS implementation in C programming language. Made for raising pull requests.*
Only simple codes are used to make the code beginner friendly :)
...
9. 
10. Now add a title, some description! 
